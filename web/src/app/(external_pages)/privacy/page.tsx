        ...
        <section className="mx-auto max-w-4xl px-12 py-24 pt-32 md:pt-32 sm:gap-48">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            ...
            <ul>
              ...
              <li>Arguments and text inputs you submit for analysis.</li>
              <li>Usage data (how you interact with the Service).</li>
              <li>Session history and debate analytics.</li>
            </ul>

            <h2>2. How We Use Your Information</h2>
            <p>Your data is used to:</p>
            <ul>
              <li>Analyze your arguments for logical fallacies and strength.</li>
              <li>Evaluate reputational risk and toxicity.</li>
              <li>Provide AI-powered debate simulation and feedback.</li>
              <li>Improve the accuracy and relevance of the Service.</li>
              <li>Communicate updates, changes, and relevant features.</li>
            </ul>
